...
setuptools.setup(
    ...
    version=version,
    install_requires=[
        'odoo-addon-api_log>=16.0dev,<16.1dev',
        'odoo-addon-api_log_mail>=16.0dev,<16.1dev',
        ...
        'odoo-addon-fastapi_log>=16.0dev,<16.1dev',
        'odoo-addon-fastapi_log_mail>=16.0dev,<16.1dev',
